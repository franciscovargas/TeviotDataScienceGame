...
final_filename = 'fine_rbm_weights_vgg1.h5'
...
logger.debug('Saving labels in file "../data/csv_lables/subsecond.csv"')

submission_example = pd.read_csv("../data/csv_lables/sample_submission4.csv")
submission_example["label"] = results
submission_example.to_csv("../data/csv_lables/subsecond.csv",index=False)
logger.debug( "Submitted at: " + ("../data/csv_lables/subsecond.csv") )
